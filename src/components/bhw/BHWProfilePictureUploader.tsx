...
interface BHWProfilePictureUploaderProps {
  readonly className?: string
}

export function BHWProfilePictureUploader(props: BHWProfilePictureUploaderProps) {
  ...
  const profilePictureUrl = bhwAccount.profilePicture
  ...
  async function handleFileChange(event: ChangeEvent<HTMLInputElement>) {
    ...
    const storagePath = `bhw-profile-pictures/${account?.id}.${fileExtension}`
