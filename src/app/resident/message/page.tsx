                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-xs text-gray-500 ml-4">
                          {message.createdAt && typeof message.createdAt === 'object' && 'toDate' in message.createdAt
                            ? formatDate(message.createdAt as { toDate: () => Date })
                            : 'N/A'}
                        </div>
                      </div>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <span className="font-semibold">Date:</span> {
                      selectedMessage.createdAt && typeof selectedMessage.createdAt === 'object' && 'toDate' in selectedMessage.createdAt
                        ? (selectedMessage.createdAt as { toDate: () => Date }).toDate().toLocaleString()
                        : 'N/A'
                    }
                  </div>
                  <div>
