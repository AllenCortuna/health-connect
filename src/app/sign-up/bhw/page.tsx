...
interface BHWSignupFormData {
    email: string;
    password: string;
    confirmPassword: string;
}

const BHWSignup: React.FC = () => {
    const router = useRouter();
    const [formData, setFormData] = useState<BHWSignupFormData>({
        email: "",
        password: "",
        confirmPassword: "",
    });
                ...
                <div className="card-body">
                    <div className="text-center mb-6">
                        <h1 className="text-2xl font-bold text-secondary">
                            Barangay Health Worker Signup
                        </h1>
                        <p className="text-secondary/60 text-xs mt-2">
                            Create your barangay health worker account to get started
                        </p>
                    </div>
