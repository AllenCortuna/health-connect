...
const CreateMessage = () => {
  ...
  const [messageType, setMessageType] = useState<'resident' | 'admin'>('resident')
  ...
  // Search for residents and admins
        ...
        <div className="card bg-base-100 shadow-lg">
          <div className="card-body">
              ...
              <div className="flex gap-4">
                <label className="label cursor-pointer">
                  <input
                    ...
                    onChange={(e) => setMessageType(e.target.value as 'resident' | 'admin')}
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text font-semibold">Search {messageType === 'resident' ? 'Household' : 'Admin'}</span>
              </label>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="text-sm opacity-70">
                            {result.type === 'resident' ? 'Resident' : 'Admin'}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm opacity-80">
                      {selectedRecipient.type === 'resident' ? 'Resident' : 'Admin'}
                    </div>
                  </div>
                  <button
                    type="button"
